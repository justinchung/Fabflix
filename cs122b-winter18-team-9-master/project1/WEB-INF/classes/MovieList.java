...
public class MovieList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<tr><th>Title</th><th>Year</th><th>Directed by</th><th>Starring</th><th>Genre(s)</th><th>Rating</th>");
           ...
           int i = 1;
            while (rs.next()) {
                ...
                out.println("<tr>" + "<td>" + i + "</td>" + "<td>" + m_title + "</td>" + "<td>" + m_year + "</td>" + "<td>" + m_director + "</td>" + "<td>" + actors + "</td>" + "<td>" + genres + "</td>" + "<td>" + rating + "</td>"
                        + "</tr>");
                i++;
            }           
